...
def eval_adv_test_whitebox(model, device, test_loader, args):
    ...
    for i, (data, target) in enumerate(test_loader):
        ...
        acc_natural, acc_robust = _pgd_whitebox(model, X, y, args, viz)
        robust_acc_total.append(acc_robust)
        natural_acc_total.append(acc_natural)
        counter += 1
    # print('natural_acc_total: ', natural_acc_total)
    # print('robust_acc_total: ', robust_acc_total)
